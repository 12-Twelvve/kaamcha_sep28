...
export const About = () => {
  return (
    <div
      className="about"
      style={{ margin: "0 10vw", display: "flex", flexDirection: "column" }}
    >
      <div
      ...
      >
        ...
        <p style={{ margin: "0 10vw", align: "center" }}>
          ...
          marketplace. We connect over 900 M helpless, superheroes and sidekicks
      ...
      <div className="about_team" style={{ margin: "0 20vw", align: "center" }}>
